...
class HONDAFRONTENAC():
    ...
    def processing_each_vehicle(self, vehicle_url):
       ...
       date_in_stock = ''
       street_addr = '885 S Lindbergh Blvd'
       locality = 'St. Louis'
       postal_code = '63131'
       region = 'MO'
       country = 'US'
       location = 'Honda of Frontenac'
       ...
       json_data = self.get_all_vehicles(f'https://www.hondafrontenac.com/api/Inventory/getPaymentSettingDetails?accountId=44173&vin={vin}&styleid=', is_json=True)
    ...
    def start_scraping_hondafrontenac(self):
       ...
       soup = self.get_all_vehicles('https://www.hondafrontenac.com/sitemap.xml')
