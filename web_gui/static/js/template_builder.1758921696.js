...
class TemplateBuilder {
    ...
    bindEvents() {
        ...
        document.getElementById('createCombinedFieldBtn')?.addEventListener('click', () => this.openFieldConcatenationModal());
    ...
    openFieldConcatenationModal() {
        ...
        // Reset form
        this.selectedFields = [];
        document.getElementById('combinedFieldName').value = '';
        document.getElementById('combinedFieldKey').value = '';
        document.getElementById('fieldSeparator').value = ' ';
        ...
        // Show modal
        document.getElementById('fieldConcatenationModal').style.display = 'flex';
    }
