"""
Import Dave Sinclair Lincoln St. Peters VIN log with order number grouping
"""
import sys
import csv
...
# Configuration
CSV_FILE = r"C:\Users\Workstation_1\Downloads\DAVESINCLAIRSTPETERS_VINLOG - LOG.csv"
TABLE_NAME = "dave_sinclair_lincoln_st_peters_vin_log"
...
def import_vinlog():
    ...
    print(f"\n{'='*80}")
    print(f"Dave Sinclair Lincoln St. Peters VIN Log Import")
    print(f"{'='*80}\n")
