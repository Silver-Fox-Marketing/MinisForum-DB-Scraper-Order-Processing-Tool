"""
Re-import Pundmann Ford VIN log with order number grouping
"""
import sys
import csv
...
# Configuration
CSV_FILE = r"C:\Users\Workstation_1\Downloads\PUNDMANN_VINLOG - LOG.csv"
TABLE_NAME = "pundmann_ford_vin_log"
...
def reimport_vinlog():
    ...
    print(f"\n{'='*80}")
    print(f"Pundmann Ford VIN Log Re-Import with Order Numbers")
    print(f"{'='*80}\n")
